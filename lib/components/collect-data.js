        ...
        <CollectDataWrapper>
            ...
            <Radio
                onChange={(value) => {
                    ...
                    setState({...state, radioState: value });
                }}
                label=""
                options={[
                    { label: 'Yes, you can collect my data', value: "true" },
                    { label: 'No, you cant collect my data', value: "false" }
                ]}
                selected={radioState}
                />
            </CollectDataForm>
...
const CollectDataForm = styled.div`
    display: flex;
    flex-direction: column;
    gap: 12px;
    margin-top: 28px;
