									...
									content: (
										<>
											<Container>
												<InputContainer>
												{
													Object.keys(connections).length > 0 && !createNewConnection && !scheduleId ? (
														<>
															<Select
															label="Select Connection"
															options={[
																...Object.keys(connections).map((connection_name) => ({
															...
															onChange={(value) =>
																handleInputChange(value, 'selectedConnection')
															}
															required
												...
												{
													includeAsConnection && selectedConnection === 'not_set' ? (
														<Container>
