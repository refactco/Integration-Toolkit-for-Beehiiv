...
const ScheduledImport = () => {
	...
	return (
		<>
			...
			/>
			{	showAddNewScheduleModal ? <AddNewScheduleModal onClose={closeAddNewScheduleModalHandler} handleRefreshScheduleData={handleRefreshScheduleData} scheduleId={scheduleId} /> : null	}
		</>
	);
};
